...
# ]
#Spotlight::Engine.config.external_resources_partials = ["dpla_resources/form", "oregon_digital_resources/form"]
Spotlight::Engine.config.external_resources_partials = ["oregon_digital_resources/form"]
